...
#undef HERBARY_STD_DEFINE__STATIC_ASSERT_H_INCLUDED_BOOL
#define HERBARY_STD_DEFINE__STATIC_ASSERT_H_INCLUDED_BOOL 1
...
#ifdef _HERBARY_STD_DEFINE__STATIC_ASSERT_H_GET_STATIC_ASSERT_IMPL
#error "`_HERBARY_STD_DEFINE__STATIC_ASSERT_H_GET_STATIC_ASSERT_IMPL` mustn't be pre-defined"
#endif // _HERBARY_STD_DEFINE__STATIC_ASSERT_H_GET_STATIC_ASSERT_IMPL
